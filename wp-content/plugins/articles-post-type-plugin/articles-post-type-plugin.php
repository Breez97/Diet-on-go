...
class CustomArticles {
    public function __construct() {
        ...
        add_filter('template_include', [$this, 'include_custom_article_template']);
    ...
    public function include_custom_article_template($template) {
        if (is_single() && get_post_type() === 'articles') {
            $custom_template = plugin_dir_path(__FILE__) . 'templates/single-article.php';
...
if (class_exists('CustomArticles')) {
    $custom_articles_plugin = new CustomArticles();
}
